...
urlpatterns = [
    ...
    path("sales/list/branch/<str:branch_pk>/", views.sales_list_by_branch, name="sales_list_by_branch_filter"),
    path("sales/create/", views.create_sales_record, name="create_sales_record"),
    path("sales/<str:pk>/", views.SalesRecordDetailView.as_view(), name="sales_record_detail"),
