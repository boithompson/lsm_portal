...
class VehicleForm(forms.ModelForm):
    class Meta:
        model = Vehicle
        fields = [
            'image', 'customer_name', 'address', 'phone', 'vehicle_make', 'model', 'year',
            'chasis_no', 'licence_plate', 'date_of_first_registration', 'mileage', 'complaint'
        ]
        widgets = {
            ...
            'date_of_first_registration': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
